...
public class ItemDTO {
    ...
    public ItemDTO(int itemNumber, String itemName, String itemJob, int itemPrice, int itemLevel, int itemJobNumber, String effect, ArrayList<ItemDTO> healerItemDTO, ArrayList<ItemDTO> tankerItemDTO, ArrayList<ItemDTO> dealerItemDTO) {
